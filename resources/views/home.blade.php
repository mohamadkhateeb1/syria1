<x-front-layout title="Home">
    ...
    <div class="slider_area">
        ...
        <div class="ilstration_img wow fadeInRight d-none d-lg-block text-right" data-wow-duration="1s"
            data-wow-delay=".2s">
            <img src="{{ asset('assets/website/img/banner/illustration.png') }}" alt="">
        </div>
    </div>
    <!-- slider_area_end -->
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        <div class="single_jobs white-bg d-flex justify-content-between">
                            <div class="jobs_left d-flex align-items-center">
                                <div class="thumb">
                                    <img src="{{ asset('assets/website/img/svg_icon/1.svg') }}" alt="">
                                </div>
                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="single_jobs white-bg d-flex justify-content-between">
                            <div class="jobs_left d-flex align-items-center">
                                <div class="thumb">
                                    <img src="{{ asset('assets/website/img/svg_icon/2.svg') }}" alt="">
                                </div>
                                <div class="jobs_conetent">
                                    <a href="job_details.html">
